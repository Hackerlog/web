...
const BASE_PATH = process.env.REACT_APP_BASE_URL || 'http://localhost:8000';
...
export class BaseAPI {
  ...
  constructor(
    ...
    protected fetch: FetchAPI = window.fetch
  ) {
    if (configuration) {
    ...
    coreVersionGet(xHackerlogEditorToken: string, options: any = {}): FetchArgs {
      ...
      if (xHackerlogEditorToken === null || xHackerlogEditorToken === undefined) {
        throw new RequiredError(
          'xHackerlogEditorToken',
          'Required parameter xHackerlogEditorToken was null or undefined when calling coreVersionGet.'
        );
      }
...
export const CoreApiFp = function(configuration?: Configuration) {
  return {
     ...
     */
    coreVersionGet(
      xHackerlogEditorToken: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<MainVersionResponse> {
      const localVarFetchArgs = CoreApiFetchParamCreator(configuration).coreVersionGet(
        xHackerlogEditorToken,
        options
      );
...
export const CoreApiFactory = function(
  ...
  return {
    ...
    coreVersionGet(xHackerlogEditorToken: string, options?: any) {
      return CoreApiFp(configuration).coreVersionGet(xHackerlogEditorToken, options)(
        fetch,
        basePath
      );
    },
...
export class CoreApi extends BaseAPI {
  ...
  public coreVersionGet(xHackerlogEditorToken: string, options?: any) {
    return CoreApiFp(this.configuration).coreVersionGet(xHackerlogEditorToken, options)(
      this.fetch,
      this.basePath
    );
  }
 ...
 * @export
 */
export const MailingListApiFactory = function(
  configuration?: Configuration,
  fetch?: FetchAPI,
  basePath?: string
) {
  ...
  return {
    ...
    unitsGet(xHackerlogEditorToken: string, options: any = {}): FetchArgs {
      ...
      if (xHackerlogEditorToken === null || xHackerlogEditorToken === undefined) {
        throw new RequiredError(
          'xHackerlogEditorToken',
          'Required parameter xHackerlogEditorToken was null or undefined when calling unitsGet.'
        );
      }
...
export const UnitsApiFp = function(configuration?: Configuration) {
  return {
    ...
    unitsGet(
      xHackerlogEditorToken: string,
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<Array<MainUnit>> {
      const localVarFetchArgs = UnitsApiFetchParamCreator(configuration).unitsGet(
        xHackerlogEditorToken,
        options
      );
      return (fetch: FetchAPI = window.fetch, basePath: string = BASE_PATH) => {
...
export class UnitsApi extends BaseAPI {
  ...
  public unitsGet(xHackerlogEditorToken: string, options?: any) {
    return UnitsApiFp(this.configuration).unitsGet(xHackerlogEditorToken, options)(
      this.fetch,
      this.basePath
    );
  }
